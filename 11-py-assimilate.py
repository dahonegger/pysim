...
namep      = 'assimilate_out.nc'
out_name   = assimilate_dir + assimSubDir + namep
...
os.system('cp -fr  base_info.py        ' + totPath)

# Write to text file what used to be the directory and file names
fid = open('params.txt','wb')
fid.write(file_sufix + '\n')
fid.close()

if True:
    figname = assimilate_dir + assimSubDir + 'pic'
