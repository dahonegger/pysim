...
def load_dirs(itr,base): # Loads premade output directories for each assimilation iteration
    logf('create_dirs()',  base ,logfile)
    dirs=[]
    dirs.append(base+ '00_prior')
    dirs.append(base+ '01_bat_inp')
...
def do_assimilate_py(itr, dirs):
    ...
    comm = 'ssh tirigan  "cd  '+ dirs[5]+'; /home/nmg/nmg/opt/anaconda/bin/python  -u '+ do_assim_python+'  '+str(itr)+' ; touch assimdone "'
    print comm
    os.system(comm)
